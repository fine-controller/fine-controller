...
namespace Systems.KubernetesSystem
{
	public interface IKubernetesSystem
	{
		...
		public Task<IEnumerable<CustomResourceDefinitionResourceObject>> GetWebApiCustomResourceDefinitionsAsync(WebApiResourceObject webApiResourceObject, CancellationToken cancellationToken);
